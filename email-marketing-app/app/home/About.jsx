  ...
  return (
    <section className='bg-backGround'>
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 px-8 py-16 md:py-28 items-center md:gap-10 lg:gap-40">
          <h2 className="font-Roboto font-semibold text-3xl text-center text-navyBlue mb-10 md:hidden">About Us</h2>
            <div className="">
                <Image src='/assets/images/Group 1000000895.svg' alt='About image' width='100' height='100' className='w-full' />
            </div>
            <div className="mt-10 md:mt-0">
                <h2 className="font-Roboto font-semibold md:text-4xl lg:text-5xl text-navyBlue mb-10 hidden md:block">About Us</h2>
